...
from Network import Network,tw_list
...
# Metedata
#===========
wait0 = 0 # For different network, we use different wait0, which is the time have to wait to generate all the seeds.
#===========
# Parameters
#===========
beta = 66.7
...
def host(L=L, M=M, N=N, tot_steps=tot_steps, beta=beta, N_in=N_in, N_out=N_out, tw=tw, init=init):
    ...
    # Load data 
    o.S_in = np.load('../data/{:s}/seed_S_in_M{:d}_N_in{:d}_beta{:3.1f}.npy'.format(str_timestamp,M,N_in,beta))
    o.S_out = np.load('../data/{:s}/seed_S_out_M{:d}_N_out{:d}_beta{:3.1f}.npy'.format(str_timestamp,M,N_out,beta))
    print("shape of S_in:")
    print(o.S_in.shape)
    #========================================================================================================================================================
    ...
    o.J_in = np.load('../data/{:s}/seed_J_in_{:s}_init{:d}_tw{:d}_N{:d}_N_in{:d}_beta{:3.1f}.npy'.format(str_timestamp,str_timestamp,init,tw,N,N_in,beta))
    o.J_out = np.load('../data/{:s}/seed_J_out_{:s}_init{:d}_tw{:d}_N_out{:d}_N{:d}_beta{:3.1f}.npy'.format(str_timestamp,str_timestamp,init,tw,N_out,N,beta))
    o.J_hidden = np.load('../data/{:s}/seed_J_hidden_{:s}_init{:d}_tw{:d}_L{:d}_N{:d}_beta{:3.1f}.npy'.format(str_timestamp,str_timestamp,init,tw,L,N,beta))
    o.S = np.load('../data/{:s}/seed_S_{:s}_init{:d}_tw{:d}_L{:d}_M{:d}_N{:d}_beta{:3.1f}.npy'.format(str_timestamp,str_timestamp,init,tw,L,M,N,beta))
    #=========================================================================================================================================================
    print("tw (host):")
    print(tw)
    ...
    o.mc_main_random_update_hyperfine(str_timestamp)        

    # Save the state of S and J at this end of the epoch of training
    np.save('../data/{:s}/S_{:s}_init{:d}_tw{:d}_L{:d}_M{:d}_N{:d}_beta{:3.1f}_step{:d}.npy'.format(str_timestamp,str_replica_index,o.init,o.tw,o.L,o.M,o.N,o.beta,tot_steps),o.S_traj_hyperfine)
    np.save('../data/{:s}/J_in_{:s}_init{:d}_tw{:d}_N{:d}_N_in{:d}_beta{:3.1f}_step{:d}.npy'.format(str_timestamp,str_replica_index,o.init,o.tw,o.N,o.N_in,o.beta,tot_steps),o.J_in_traj_hyperfine)
    np.save('../data/{:s}/J_out_{:s}_init{:d}_tw{:d}_N_out{:d}_N{:d}_beta{:3.1f}_step{:d}.npy'.format(str_timestamp,str_replica_index,o.init,o.tw,o.N_out,o.N,o.beta,tot_steps),o.J_out_traj_hyperfine)
   #np.save('../data/{:s}/J_out_{:s}_init{:d}_tw{:d}_N_out{:d}_N{:d}_beta{:3.1f}_step{:d}.npy'.format(str_timestamp,str_replica_index,o.init,o.tw,o.N_out,o.N,o.beta,tot_steps),o.J_out_traj_hyperfine)
    np.save('../data/{:s}/J_hidden_{:s}_init{:d}_tw{:d}_L{:d}_N{:d}_beta{:3.1f}_step{:d}.npy'.format(str_timestamp,str_replica_index,o.init,o.tw,o.L,o.N,o.beta,tot_steps),o.J_hidden_traj_hyperfine)
    np.save('../data/{:s}/ener_new_{:s}_init{:d}_tw{:d}_L{:d}_M{:d}_N{:d}_beta{:3.1f}_step{:d}.npy'.format(str_timestamp,str_replica_index,o.init,o.tw,o.L,o.M,o.N,o.beta,tot_steps),o.H_hidden_traj_hyperfine)
...
def guest(L=L, M=M, N=N, tot_steps=tot_steps, beta=beta, N_in=N_in, N_out=N_out, tw=tw, init=init):
    ...
    # Run MC simulations
    o.mc_random_update_hyperfine(str_timestamp) 
    # Save the state of S and J at this end of the epoch of training
    np.save('../data/{:s}/S_{:s}_init{:d}_tw{:d}_L{:d}_M{:d}_N{:d}_beta{:3.1f}_step{:d}.npy'.format(str_timestamp,str_replica_index,o.init,o.tw,o.L,o.M,o.N,o.beta,tot_steps),o.S_traj_hyperfine)
    np.save('../data/{:s}/J_in_{:s}_init{:d}_tw{:d}_N{:d}_N_in{:d}_beta{:3.1f}_step{:d}.npy'.format(str_timestamp,str_replica_index,o.init,o.tw,o.N,o.N_in,o.beta,tot_steps),o.J_in_traj_hyperfine)
    np.save('../data/{:s}/J_out_{:s}_init{:d}_tw{:d}_N_out{:d}_N{:d}_beta{:3.1f}_step{:d}.npy'.format(str_timestamp,str_replica_index,o.init,o.tw,o.N_out,o.N,o.beta,tot_steps),o.J_out_traj_hyperfine)
...
def init_clean(L=L, M=M, N=N, tot_steps=tot_steps, beta=beta, N_in=N_in, N_out=N_out, tw=tw, init=init):
    ...
    src_dir = os.path.dirname(__file__) # <-- absolute dir the script is in

    ##========================================================
    ## Save the arrays in the created directory
    ##========================================================
    # Save the initial configures:
    np.save('{}/{:s}/seed_S_{:s}_init{:d}_tw{:d}_L{:d}_M{:d}_N{:d}_beta{:3.1f}.npy'.format(data,str_timestamp,str_timestamp,init,tw,L,M,N,beta),o.S)
    np.save('{}/{:s}/seed_J_hidden_{:s}_init{:d}_tw{:d}_L{:d}_N{:d}_beta{:3.1f}.npy'.format(data,str_timestamp,str_timestamp,init,tw,L,N,beta),o.J_hidden)
    np.save('{}/{:s}/seed_J_in_{:s}_init{:d}_tw{:d}_N{:d}_N_in{:d}_beta{:3.1f}.npy'.format(data,str_timestamp,str_timestamp,init,tw,N,N_in,beta),o.J_in)
    np.save('{}/{:s}/seed_J_out_{:s}_init{:d}_tw{:d}_N_out{:d}_N{:d}_beta{:3.1f}.npy'.format(data,str_timestamp,str_timestamp,init,tw,N_out,N,beta),o.J_out)
    ...
    np.save('{}/{:s}/seed_S_in_M{:d}_N_in{:d}_beta{:3.1f}.npy'.format(data,str_timestamp,M,N_in,beta),o.S_in)
    np.save('{}/{:s}/seed_S_out_M{:d}_N_out{:d}_beta{:3.1f}.npy'.format(data,str_timestamp,M,N_out,beta),o.S_out)
...
if __name__=='__main__':
    ...
    #print("host is running and some seeds are prepared!")
    #sleep(wait0)
